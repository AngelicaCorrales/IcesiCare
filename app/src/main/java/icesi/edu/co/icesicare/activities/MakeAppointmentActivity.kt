...
class MakeAppointmentActivity : AppCompatActivity() {
    ...
    fun showFragmentPsychList(){
        ...
        supportFragmentManager.beginTransaction().replace(R.id.makeApptFragmentContainer,makeAppntPsychListFragment).commit()
    ...
    fun showFragmentPsychDetail(psych:Psychologist?){
        ...
        supportFragmentManager.beginTransaction().replace(R.id.makeApptFragmentContainer,makeAppntPsychDetailFragment).commit()
